...
WEEK_OVERRIDES = {
    ...
    "2026-07-28": {
        "Monday":    "ROUVY 60 min easy Z2 (NP 130-140w, tri bike on trainer if set up) + easy run 3mi walk/run 9/1.",
        "Tuesday":   "Pool swim 2,000m easy (4x100 steady) + Run Club (walk/run protocol).",
        "Wednesday": "ROUVY 60 min easy Z2 (NP 130-140w, aero position on trainer).",
        "Thursday":  "Pool swim 2,000m easy + easy run 3mi walk/run 9/1. Protect hip, keep easy.",
        "Friday":    "Rest.",
        "Saturday":  "Outdoor ride 60 min easy Z2 -- start aero position time on QR Kilo. ROUVY if weather forces it.",
        "Sunday":    "Long run 5mi walk/run 9/1 -- first long run of Sacramento build. Note hip status after.",
    },
    "2026-08-03": {
        "Monday":    "ROUVY 60 min (NP 135-145w, aero) + easy run 3mi walk/run 9/1.",
        "Tuesday":   "Pool swim 2,500m (4x100 steady) + Run Club (walk/run protocol).",
        "Wednesday": "Outdoor ride 75 min + brick run 25 min (walk/run 9/1) -- first brick of Sacramento block. Outdoor preferred.",
        "Thursday":  "Pool swim 2,500m (4x100 steady) + easy run 4mi walk/run 9/1.",
        "Friday":    "Rest.",
        "Saturday":  "Outdoor ride 90 min Z2 -- aero position on QR Kilo. Back needs to adapt to 112mi in aero.",
        "Sunday":    "Long run 6mi walk/run 9/1 -- building distance. Note hip status after.",
    },
    "2026-08-10": {
        ...
        "Wednesday": "Outdoor ride 90 min + brick run 30 min at 11:00/mi (walk/run 9/1) -- outdoor mandatory, aero conditioning.",
        "Thursday":  "Pool swim 3,000m (4x200 steady) + easy run 4mi walk/run 9/1.",
        "Friday":    "Rest -- recovery before long run Sunday.",
        "Saturday":  "Outdoor long ride 50mi at ~17mph -- first post-bike-fit outdoor ride on QR Kilo.",
        "Sunday":    "Long run 8mi walk/run 9/1 -- first real hip test. Note status carefully after.",
    },
    "2026-08-17": {
        ...
        "Wednesday": "Outdoor ride 100 min + brick run 35 min at 11:00/mi (walk/run 9/1) -- outdoor mandatory, aero conditioning.",
        ...
        "Sunday":    "Long run 10mi walk/run 9/1 -- Oregon proved this is doable. Note hip status after.",
    },
    "2026-08-24": {
        ...
        "Wednesday": "Easy ride 60 min -- Z2 only, NP under 135w, recovery week.",
        "Thursday":  "Pool swim 2,000m easy + easy run 3mi walk/run 9/1.",
        "Friday":    "Rest.",
        "Saturday":  "Easy ride 60 min -- recovery week, keep aero adaptation going.",
        "Sunday":    "Long run 6mi walk/run 9/1 -- recovery week long run, keep it easy.",
    },
    "2026-08-31": {
        ...
        "Wednesday": "Outdoor 3hr ride at ~17mph + brick run 45 min at 11:00/mi (walk/run 9/1) -- KEY SESSION. Must be outdoor.",
        ...
        "Sunday":    "Long run 12mi walk/run 9/1 -- key hip test, biggest run yet. Note status carefully.",
    },
    "2026-09-07": {
        ...
        "Thursday":  "Pool swim 3,000m race effort + easy run 4mi walk/run 9/1. Recover from Wednesday.",
        "Friday":    "Rest -- protect the legs before long run Sunday.",
        "Saturday":  "ROUVY 90 min NP 142-150w -- maintain stimulus.",
        "Sunday":    "Long run 14mi walk/run 9/1 -- peak long run. Hip will be tested here. Note everything.",
    },
    "2026-09-14": {
        "Monday":    "ROUVY 90 min (NP 142-150w) + easy run 4mi walk/run 9/1.",
        "Tuesday":   "Pool swim 3,000m (4x200 race effort) + Run Club (walk/run, peak week energy).",
        "Wednesday": "Outdoor ride 90 min at ~17mph + brick run 50 min at 11:00/mi (walk/run 9/1) -- full race nutrition practice.",
        ...
        "Sunday":    "Long run 16mi walk/run 9/1 -- PEAK LONG RUN. If hip handles this, you are ready for Sacramento. Note everything.",
    },
    "2026-09-21": {
        "Monday":    "ROUVY 75 min (NP 140-148w) + easy run 4mi walk/run 9/1. Step down begins.",
        "Tuesday":   "Pool swim 2,500m (4x100 race pace) + Run Club (walk/run, step down week).",
        "Wednesday": "Outdoor ride 75 min + brick run 35 min at 11:00/mi (walk/run 9/1) -- outdoor preferred.",
        "Thursday":  "Pool swim 2,500m race pace + easy run 4mi walk/run 9/1.",
        "Friday":    "Rest -- recovery before long run Sunday.",
        "Saturday":  "Easy ride 60 min -- step down, outdoor preferred.",
        "Sunday":    "Long run 10mi walk/run 9/1 -- step down from peak, legs should feel good.",
    },
    "2026-09-28": {
        ...
        "Wednesday": "Easy ride 45 min -- taper, NP under 140w, outdoor or trainer fine.",
        "Thursday":  "Pool swim 2,000m race pace + easy run 3mi walk/run 9/1, 4x30 sec strides.",
        "Friday":    "Rest.",
        "Saturday":  "OW swim easy 1,500m at La Jolla -- easy aerobic.",
        "Sunday":    "Long run 8mi walk/run 9/1 -- taper long run, legs should feel springy.",
    },
    "2026-10-05": {
        "Monday":    "ROUVY 30 min easy + easy jog 3mi (4 strides, feel fresh). Race week prep begins.",
        "Tuesday":   "Pool swim 1,500m (4x50 race pace) -- last quality swim + Run Club (easy, last run club before Sacramento).",
        "Wednesday": "Bike reassembly check 20 min -- confirm shifting and brakes.",
        ...
        "Sunday":    "Easy jog 3mi walk/run -- last run before race week. Easy.",
    },
    "2026-10-12": {
...
- Sacramento 140.6 build: WEEK {current_week} OF 13. Full Ironman -- 2.4mi swim / 112mi bike / 26.2mi run. Goal: sub-13:00. Key focuses: (1) bike fit to fix back and foot pain, (2) progressive long run building to 16mi by Week 9, (3) brick consistency with 60min run off long bikes in peak weeks. Walk/run protocol: 9 min run / 1 min walk on ALL runs. Easy runs max 4-5mi. Long run on Sundays builds: 5mi(Wk2), 6mi(Wk3), 8mi(Wk4), 10mi(Wk5), 6mi(Wk6), 12mi(Wk7), 14mi(Wk8), 16mi(Wk9 PEAK), 10mi(Wk10), 8mi(Wk11), 5mi(Wk12). Athlete ran 10+ miles at Oregon with no hip issues -- hip is resilient. Build the long run, test the hip progressively. Bike NP target TBD pending bike fit.
